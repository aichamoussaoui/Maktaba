        ...
        withContext(Dispatchers.IO) {
            ...
            if (imageUri != null) {
                try {
                    ...
                    Log.e("SupabaseBookRepo", "Storage upload failed - continuing without image", e)
                    // لا تقم برمي الخطأ (throw e)، لكي يستمر البرنامج في إضافة بيانات الكتاب حتى بدون صورة
                }
            }
